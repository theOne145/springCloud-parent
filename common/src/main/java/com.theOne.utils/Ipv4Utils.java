...
public class Ipv4Utils {
	...
	public static String[] getIPAddrScope(String ipAndMask) {
		...
		return new String[] { Ipv4Utils.intToIp(ipIntArr[0]), Ipv4Utils.intToIp(ipIntArr[0]) };
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("byte[]: " + byteStr + " --> IP: " + Ipv4Utils.bytesToIp(bytearr));

		int ipInt = Ipv4Utils.ipToInt(ipAddr);

		System.out.println("IP: " + ipAddr + "  --> int: " + ipInt);

		System.out.println("int: " + ipInt + " --> IP: " + Ipv4Utils.intToIp(ipInt));
		...
		System.out.println(ipAndMask + " --> IP 地址段：[ " + Ipv4Utils.intToIp(ipscope[0]) + ","
		...
		System.out.println(ipAddr1 + " , " + ipMask1 + "  --> IP地址段 ：[ " + Ipv4Utils.intToIp(ipscope1[0]) + ","
